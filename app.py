...
app.title = "Stellar Enlightenment"
background_image_url = '/assets/stellar bgimg5.jpeg'
...
app.layout = html.Div(
    ...
    html.Div(children=[
        html.Div(children=[
            html.Div(children='Ascension angle', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='alpha',
                min=0,
                max=360,
                ...
                marks={
                    ...
                    360: {'label': '360', 'style': {'color': 'white'}}
                },
                tooltip={"placement": "bottom", "always_visible": True}
            ),
            html.Div(children='Declination angle', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='delta',
                min=0,
                max=360,
            ...
            html.Div(children='Ultraviolet', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='u',
                min=0,
                max=30,
            ...
            html.Div(children='Green', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='g',
                min=0,
                max=30,
            ...
            html.Div(children='Red', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='r',
                min=0,
                max=30,
            ...
            html.Div(children='Infrared (I)', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='i',
                min=0,
                max=30,
            ...
            html.Div(children='Infrared (Z)', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='z',
                min=0,
                max=30,
            ...
            html.Div(children='Redshift', style={'fontSize': 15,'color':'white'}),
            dcc.Slider(
                id='redshift',
                min=0,
                max=10,
    ...
    html.Div([html.P(children='Stellar Classification')], 
     ...
     style={
         'background': f'url("{background_image_url}")',
         'height': '100vh', 
         'overflow': 'cover',
         'position':'relative',
    }
...
def ml_application(alpha, delta, u, g, r, i, z, redshift):
    ...
    image_credits = html.Span(
        f"A random {pred_class.lower()} image taken from nasa.gov image gallery.",
        style={'color': 'white',}
    )
